  ...
  return (
    <div  id='about' className='bg-white w-full max-h-[400] p-10'>
        ...
        <div className='p-4 bg-slate-50 flex justify-evenly items-center flex-nowrap '>
            <div className='w-4/6 '>
                <img className='h-30 sm:h-52 rounded-2xl  md:rounded-md xl:float-right xl:pr-4' src="/images/cake2.jpeg" alt="" />
            </div>
            <div className='w-11/12 xl:pr-20'>
                ...
                <div className='flex gap-2 justify-center items-center'>
                    <div >
                        <img className='w-24 h-24' src="/images/about1.jpeg" alt="" />
                    ...
                    <div>
                        <img className='w-24 h-24' src="/images/about2.jpeg" alt="" />
